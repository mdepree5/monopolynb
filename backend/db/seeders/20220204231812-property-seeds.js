...
module.exports = {
  up: (queryInterface, Sequelize) => queryInterface.bulkInsert('Properties', [
    ...
    { hostId: 2, title: 'States Avenue', numberOfBeds: 4, price: 50, address: 'S States Ave', city: 'Atlantic City', state: 'New Jersey', zipcode: '08401' },
    { hostId: 2, title: 'Virginia Avenue', numberOfBeds: 4, price: 60, address: 'N Virginia Ave', city: 'Atlantic City', state: 'New Jersey', zipcode: '08401' },
    { hostId: 2, title: 'St. James Place', numberOfBeds: 4, price: 70, address: 'St James Pl', city: 'Atlantic City', state: 'New Jersey', zipcode: '08401' },
    { hostId: 2, title: 'Tennessee Avenue', numberOfBeds: 4, price: 70, address: 'S Tennessee Ave', city: 'Atlantic City', state: 'New Jersey', zipcode: '08401' },
    { hostId: 2, title: 'New York Avenue', numberOfBeds: 4, price: 80, address: 'N New York Ave', city: 'Atlantic City', state: 'New Jersey', zipcode: '08401' },
